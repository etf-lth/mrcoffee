        ...
        for line in temp:
            ...
            if line[0] == 'PING':
                ...
                if line[3] == ':!kaffe':
                    ...
                    try:
                        streambase = {'sky': 'pub2.sky.fm/sky_', 'di': 'pub6.di.fm/di_', 'blipblop': 'radio.mojt.net/blop.php?', 'kohina': 'kohina.radio.ethz.ch:8000/kohina.ogg?', 'slay': 'relay1.slayradio.org:8000/?'}
                        m = mpd.MPDConn()
                        m.cmd('clear')
